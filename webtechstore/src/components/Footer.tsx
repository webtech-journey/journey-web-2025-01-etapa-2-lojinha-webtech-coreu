...
export default function Footer() {
  return (
    <footer
      className="text-white py-12 w-full bg-[var(--footer-bg)]"
      ...
      <div className="mx-auto max-w-6xl flex flex-col md:flex-row justify-between items-start px-6 sm:px-12 lg:px-20 xl:px-28 gap-8 md:gap-12">
        <div className="flex-1 md:w-1/3 md:text-left">
          <div className="flex items-center md:justify-start gap-2 mb-3">
            <img
              src="/images/webtech-footer.png"
              alt="WebTech"
              className="h-5 w-5 object-contain"
            />
            <h2 className="text-lg font-semibold">Webtech Network</h2>
          </div>
          <p className="leading-relaxed font-medium text-xs">
            A WebTech é um projeto de extensão da PUC Minas que tem como
            objetivo gerar espaço de trabalho para que alunos e professores
            criem juntos aplicações, ferramentas e conteúdo para interessados em
            criar soluções e produtos digitais.
          </p>
        </div>
        ...
        <div className="flex-1 md:w-1/3 md:text-left w-full">
          ...
          <div className="space-y-4 w-full flex flex-col">
            ...
            <div className="w-full max-w-xs">
              ...
              <p className="text-xs font-semibold text-[#D1D5DC]">
                PUC Minas - Unidade Lourdes
                <br />
                R. Cláudio Manoel, 1162 - Savassi
                <br />
                Prédio 4 - Sala 1106
              </p>
            </div>
        ...
        <div className="flex-1 md:w-1/3 md:text-left w-full">
          ...
          <div className="w-full flex flex-col md:items-start">
            <div className="flex gap-3 md:justify-start">
              <a
                href="https://www.linkedin.com/company/webtech-network/posts/?feedView=all"
                aria-label="LinkedIn"
              ...
              <a
                href="https://github.com/webtech-network"
                aria-label="GitHub"
                className="hover:opacity-80 transition-opacity"
              >
              ...
              <a
                href="https://www.instagram.com/webtech.network/"
              ...
              <a
                href="https://www.youtube.com/channel/UCvcjBDrFKF_p8rNJSgjevIg"
                aria-label="YouTube"
                className="hover:opacity-80 transition-opacity"
              >
              ...
              <a
                href="https://discord.com/invite/zee7DKZp8C"
                aria-label="Discord"
                className="hover:opacity-80 transition-opacity"
              >
